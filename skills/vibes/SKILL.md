...
<body>
  ...
  <script type="module">
    ...
    // Render app with Vibes toggle (bottom-right, size 80 to match vibes.diy)
    ReactDOM.createRoot(document.getElementById("root")).render(
      e("div", { className: "relative" },
        e("button", {
          className: "fixed bottom-4 right-0 z-50 bg-transparent border-none cursor-pointer",
          "aria-label": "Vibes menu toggle"
        }, e(VibesSwitch, { size: 80 })),
        e(App)
      )
    );
  </script>
